...
import net.kaaass.rumbase.table.mock.MockField;
 ...
 *
 * @author @KveinAxel
 * @see net.kaaass.rumbase.table.IField
 */
public class IFieldTest extends TestCase {
    public void testStrToValue() {

        IField field = MockField.ofFile("test_str2value_int", "id", FieldType.INT);
        ...
        IField field2 = MockField.ofFile("test_str2value_float", "id", FieldType.FLOAT);
        ...
        IField field3 = MockField.ofFile("test_str2value_failed", "id", FieldType.INT);
    ...
    public void testValueToRaw() {
        ...
        IField field = MockField.ofFile("test_value2raw_int", "id", FieldType.INT);
        ...
        IField field2 = MockField.ofFile("test_value2raw_float", "id", FieldType.FLOAT);
    ...
    public void testRawToValue() {
        ...
        IField field = MockField.ofFile("test_raw2value_int", "id", FieldType.INT);
        ...
        IField field2 = MockField.ofFile("test_raw2value_float", "id", FieldType.FLOAT);
        ...
        IField field3 = MockField.ofFile("test_raw2value_failed", "id", FieldType.INT);
    ...
    public void testSearchRange() {
        ...
        IField field = MockField.ofFile("test_search_range_int", "id", FieldType.INT);
        ...
        IField field2 = MockField.ofFile("test_search_range_float", "id", FieldType.INT);
        ...
        IField field3 = MockField.ofFile("test_search_range_failed", "id", FieldType.INT);
